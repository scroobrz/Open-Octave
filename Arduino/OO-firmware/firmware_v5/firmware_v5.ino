...
Key keys[NUM_KEYS] = {
    {KEY0_BUTTON_PIN, KEY0_LED_INDEX, KEY0_SERVO_CHANNEL, KEY0_NOTE, KEY0_FPATH, KEY0_PCM, false}, // C4
    {KEY1_BUTTON_PIN, KEY1_LED_INDEX, KEY1_SERVO_CHANNEL, KEY1_NOTE, KEY1_FPATH, KEY1_PCM, false}, // C#4
    {KEY2_BUTTON_PIN, KEY2_LED_INDEX, KEY2_SERVO_CHANNEL, KEY2_NOTE, KEY2_FPATH, KEY2_PCM, false}, // D4
    {KEY3_BUTTON_PIN, KEY3_LED_INDEX, KEY3_SERVO_CHANNEL, KEY3_NOTE, KEY3_FPATH, KEY3_PCM, false}, // D#4
    {KEY4_BUTTON_PIN, KEY4_LED_INDEX, KEY4_SERVO_CHANNEL, KEY4_NOTE, KEY4_FPATH, KEY4_PCM, false}, // E4
    {KEY5_BUTTON_PIN, KEY5_LED_INDEX, KEY5_SERVO_CHANNEL, KEY5_NOTE, KEY5_FPATH, KEY5_PCM, false}, // F4
    {KEY6_BUTTON_PIN, KEY6_LED_INDEX, KEY6_SERVO_CHANNEL, KEY6_NOTE, KEY6_FPATH, KEY6_PCM, false}, // F#4
    {KEY7_BUTTON_PIN, KEY7_LED_INDEX, KEY7_SERVO_CHANNEL, KEY7_NOTE, KEY7_FPATH, KEY7_PCM, false}, // G4
    {KEY8_BUTTON_PIN, KEY8_LED_INDEX, KEY8_SERVO_CHANNEL, KEY8_NOTE, KEY8_FPATH, KEY8_PCM, false}, // G#4
    {KEY9_BUTTON_PIN, KEY9_LED_INDEX, KEY9_SERVO_CHANNEL, KEY9_NOTE, KEY9_FPATH, KEY9_PCM, false}, // A4
    {KEY10_BUTTON_PIN, KEY10_LED_INDEX, KEY10_SERVO_CHANNEL, KEY10_NOTE, KEY10_FPATH, KEY10_PCM, false}, // A#4
    {KEY11_BUTTON_PIN, KEY11_LED_INDEX, KEY11_SERVO_CHANNEL, KEY11_NOTE, KEY11_FPATH, KEY11_PCM, false}  // B4
};
