...
Key keys[NUM_KEYS] = {
    {KEY0_BUTTON_PIN, KEY0_LED_INDEX, KEY0_SERVO_CHANNEL, KEY0_FP, false}, // C4
    {KEY1_BUTTON_PIN, KEY1_LED_INDEX, KEY1_SERVO_CHANNEL, KEY1_FP, false}, // C#4
    {KEY2_BUTTON_PIN, KEY2_LED_INDEX, KEY2_SERVO_CHANNEL, KEY2_FP, false}, // D4
    {KEY3_BUTTON_PIN, KEY3_LED_INDEX, KEY3_SERVO_CHANNEL, KEY3_FP, false}, // D#4
    {KEY4_BUTTON_PIN, KEY4_LED_INDEX, KEY4_SERVO_CHANNEL, KEY4_FP, false}, // E4
    {KEY5_BUTTON_PIN, KEY5_LED_INDEX, KEY5_SERVO_CHANNEL, KEY5_FP, false}, // F4
    {KEY6_BUTTON_PIN, KEY6_LED_INDEX, KEY6_SERVO_CHANNEL, KEY6_FP, false}, // F#4
    {KEY7_BUTTON_PIN, KEY7_LED_INDEX, KEY7_SERVO_CHANNEL, KEY7_FP, false}, // G4
    {KEY8_BUTTON_PIN, KEY8_LED_INDEX, KEY8_SERVO_CHANNEL, KEY8_FP, false}, // G#4
    {KEY9_BUTTON_PIN, KEY9_LED_INDEX, KEY9_SERVO_CHANNEL, KEY9_FP, false}, // A4
    {KEY10_BUTTON_PIN, KEY10_LED_INDEX, KEY10_SERVO_CHANNEL, KEY10_FP, false}, // A#4
    {KEY11_BUTTON_PIN, KEY11_LED_INDEX, KEY11_SERVO_CHANNEL, KEY11_FP, false}  // B4
};
